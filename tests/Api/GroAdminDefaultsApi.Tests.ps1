...
Describe -tag 'GrommunioAdmin' -name 'GroAdminGroAdminDefaultsApi' {
    Context 'Get-GroAdminCreateParams' {
        It 'Test Get-GroAdminCreateParams' {
            #$TestResult = Get-GroAdminCreateParams -Domain "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Get-GroAdminDomainDefaultParams' {
        It 'Test Get-GroAdminDomainDefaultParams' {
            #$TestResult = Get-GroAdminDomainDefaultParams -DomainID "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Get-GroAdminStoreLangs' {
        It 'Test Get-GroAdminStoreLangs' {
            #$TestResult = Get-GroAdminStoreLangs
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
