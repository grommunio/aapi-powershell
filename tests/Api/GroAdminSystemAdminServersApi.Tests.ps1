...
Describe -tag 'GrommunioAdmin' -name 'GroAdminGroAdminSystemAdminServersApi' {
    Context 'Invoke-GroAdminDeleteServer' {
        It 'Test Invoke-GroAdminDeleteServer' {
            #$TestResult = Invoke-GroAdminDeleteServer -ID "TEST_VALUE" -XCsrfToken "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }

    Context 'Get-GroAdminServer' {
        It 'Test Get-GroAdminServer' {
            #$TestResult = Get-GroAdminServer -ID "TEST_VALUE" -Level "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
