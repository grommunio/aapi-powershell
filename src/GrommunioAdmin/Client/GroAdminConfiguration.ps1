...
Get the configuration object 'GroAdminConfiguration'.
...
#>
function Get-GroAdminConfiguration {

    $Configuration = $Script:Configuration

    if ([string]::IsNullOrEmpty($Configuration["BaseUrl"])) {
        $Configuration["BaseUrl"] = "/api/v1";
    }
...
System.Collections.Hashtable
#>
function Set-GroAdminConfiguration {
...
None
#>
function Set-GroAdminConfigurationApiKey {
    [CmdletBinding()]
    Param(
        [string]$Id,
        [AllowEmptyString()]
...
None
#>
function Set-GroAdminConfigurationApiKeyPrefix {
    [CmdletBinding()]
    Param(
        [string]$Id,
        [AllowEmptyString()]
...
None
#>
function Set-GroAdminConfigurationDefaultHeader {
    [CmdletBinding()]
    Param(
        [string]$Key,
        [AllowEmptyString()]
...
System.Collections.Hashtable[]
#>
function Get-GroAdminHostSetting {
    return ,@(
          @{
            "Url" = "/api/v1";
...
String
#>
function Get-GroAdminUrlFromHostSetting {
...
System.Collections.Hashtable
#>
function Set-GroAdminConfigurationHttpSigning {
    [CmdletBinding()]
    param(
    ...
    Process {
        ...
        $keyType = Get-GroAdminKeyTypeFromFile -KeyFilePath $KeyFilePath
...
Get the configuration object 'GroAdminConfigurationHttpSigning'.
...
[PSCustomObject]
#>
function Get-GroAdminConfigurationHttpSigning{
