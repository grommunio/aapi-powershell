...
function Initialize-GroAdminUserOofState {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: GrommunioAdmin => GroAdminUserOofState' | Write-Debug
...
Convert from JSON to UserOofState<PSCustomObject>
...
UserOofState<PSCustomObject>
#>
function ConvertFrom-GroAdminJsonToUserOofState {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: GrommunioAdmin => GroAdminUserOofState' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
