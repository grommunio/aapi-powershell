...
PatchUserRequest<PSCustomObject>
#>

function Initialize-GroAdminPatchUserRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: GrommunioAdmin => GroAdminPatchUserRequest' | Write-Debug
...
Convert from JSON to PatchUserRequest<PSCustomObject>
...
PatchUserRequest<PSCustomObject>
#>
function ConvertFrom-GroAdminJsonToPatchUserRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: GrommunioAdmin => GroAdminPatchUserRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GroAdminPatchUserRequest
        $AllProperties = ("username", "properties", "aliases", "status", "pop3_imap", "smtp", "changePassword", "publicAddress", "privChat", "privVideo", "privFiles", "privArchive", "ldapID", "fetchmail", "syncPolicy", "chat", "chatAdmin", "lang", "forward", "homeserver")
