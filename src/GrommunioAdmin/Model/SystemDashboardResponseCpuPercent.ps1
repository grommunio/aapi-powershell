...
SystemDashboardResponseCpuPercent<PSCustomObject>
#>

function Initialize-GroAdminSystemDashboardResponseCpuPercent {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: GrommunioAdmin => GroAdminSystemDashboardResponseCpuPercent' | Write-Debug
...
Convert from JSON to SystemDashboardResponseCpuPercent<PSCustomObject>
...
SystemDashboardResponseCpuPercent<PSCustomObject>
#>
function ConvertFrom-GroAdminJsonToSystemDashboardResponseCpuPercent {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: GrommunioAdmin => GroAdminSystemDashboardResponseCpuPercent' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GroAdminSystemDashboardResponseCpuPercent
