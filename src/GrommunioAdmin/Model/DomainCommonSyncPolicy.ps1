...
DomainCommonSyncPolicy<PSCustomObject>
#>

function Initialize-GroAdminDomainCommonSyncPolicy {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: GrommunioAdmin => GroAdminDomainCommonSyncPolicy' | Write-Debug
...
Convert from JSON to DomainCommonSyncPolicy<PSCustomObject>
...
DomainCommonSyncPolicy<PSCustomObject>
#>
function ConvertFrom-GroAdminJsonToDomainCommonSyncPolicy {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: GrommunioAdmin => GroAdminDomainCommonSyncPolicy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GroAdminDomainCommonSyncPolicy
