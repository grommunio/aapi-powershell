...
DomainsFoldersRequest<PSCustomObject>
#>

function Initialize-GroAdminDomainsFoldersRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: GrommunioAdmin => GroAdminDomainsFoldersRequest' | Write-Debug
...
Convert from JSON to DomainsFoldersRequest<PSCustomObject>
...
DomainsFoldersRequest<PSCustomObject>
#>
function ConvertFrom-GroAdminJsonToDomainsFoldersRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: GrommunioAdmin => GroAdminDomainsFoldersRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GroAdminDomainsFoldersRequest
