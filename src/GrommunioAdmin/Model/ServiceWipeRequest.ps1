...
ServiceWipeRequest<PSCustomObject>
#>

function Initialize-GroAdminServiceWipeRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: GrommunioAdmin => GroAdminServiceWipeRequest' | Write-Debug
...
Convert from JSON to ServiceWipeRequest<PSCustomObject>
...
ServiceWipeRequest<PSCustomObject>
#>
function ConvertFrom-GroAdminJsonToServiceWipeRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: GrommunioAdmin => GroAdminServiceWipeRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GroAdminServiceWipeRequest
