...
function Initialize-GroAdminLdapConfig {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: GrommunioAdmin => GroAdminLdapConfig' | Write-Debug
...
LdapConfig<PSCustomObject>
#>
function ConvertFrom-GroAdminJsonToLdapConfig {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: GrommunioAdmin => GroAdminLdapConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
