...
function ConvertFrom-GroAdminJsonToDomainCommon {
    ...
    Process {
        ...
        $AllProperties = ("ID", "orgID", "domainname", "displayname", "homedir", "maxUser", "title", "address", "adminName", "tel", "endDay", "domainStatus", "activeUsers", "inactiveUsers", "syncPolicy", "chat")
