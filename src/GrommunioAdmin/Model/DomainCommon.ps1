...
DomainCommon<PSCustomObject>
#>

function Initialize-GroAdminDomainCommon {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: GrommunioAdmin => GroAdminDomainCommon' | Write-Debug
...
Convert from JSON to DomainCommon<PSCustomObject>
...
DomainCommon<PSCustomObject>
#>
function ConvertFrom-GroAdminJsonToDomainCommon {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: GrommunioAdmin => GroAdminDomainCommon' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GroAdminDomainCommon
        $AllProperties = ('ID', 'orgID', 'domainname', 'displayname', 'homedir', 'maxUser', 'title', 'address', 'adminName', 'tel', 'endDay', 'domainStatus', 'activeUsers', 'inactiveUsers', 'virtualUsers', 'syncPolicy', 'chat')
