...
SystemCliRequest<PSCustomObject>
#>

function Initialize-GroAdminSystemCliRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: GrommunioAdmin => GroAdminSystemCliRequest' | Write-Debug
...
Convert from JSON to SystemCliRequest<PSCustomObject>
...
SystemCliRequest<PSCustomObject>
#>
function ConvertFrom-GroAdminJsonToSystemCliRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: GrommunioAdmin => GroAdminSystemCliRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GroAdminSystemCliRequest
