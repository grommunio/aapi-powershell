...
SetMemberRequest<PSCustomObject>
#>

function Initialize-GroAdminSetMemberRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: GrommunioAdmin => GroAdminSetMemberRequest' | Write-Debug
...
Convert from JSON to SetMemberRequest<PSCustomObject>
...
SetMemberRequest<PSCustomObject>
#>
function ConvertFrom-GroAdminJsonToSetMemberRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: GrommunioAdmin => GroAdminSetMemberRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
