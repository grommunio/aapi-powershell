...
DomainWrite<PSCustomObject>
#>

function Initialize-GroAdminDomainWrite {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: GrommunioAdmin => GroAdminDomainWrite' | Write-Debug
...
Convert from JSON to DomainWrite<PSCustomObject>
...
DomainWrite<PSCustomObject>
#>
function ConvertFrom-GroAdminJsonToDomainWrite {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: GrommunioAdmin => GroAdminDomainWrite' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
