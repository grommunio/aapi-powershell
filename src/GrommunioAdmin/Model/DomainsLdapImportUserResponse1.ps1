...
DomainsLdapImportUserResponse1<PSCustomObject>
#>

function Initialize-GroAdminDomainsLdapImportUserResponse1 {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: GrommunioAdmin => GroAdminDomainsLdapImportUserResponse1' | Write-Debug
...
Convert from JSON to DomainsLdapImportUserResponse1<PSCustomObject>
...
DomainsLdapImportUserResponse1<PSCustomObject>
#>
function ConvertFrom-GroAdminJsonToDomainsLdapImportUserResponse1 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: GrommunioAdmin => GroAdminDomainsLdapImportUserResponse1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GroAdminDomainsLdapImportUserResponse1
        $AllProperties = ("message", "ID", "username", "domainID", "roles", "properties", "aliases", "status", "pop3_imap", "smtp", "changePassword", "publicAddress", "privChat", "privVideo", "privFiles", "privArchive", "ldapID", "fetchmail", "syncPolicy", "chat", "chatAdmin", "lang", "forward", "homeserver")
