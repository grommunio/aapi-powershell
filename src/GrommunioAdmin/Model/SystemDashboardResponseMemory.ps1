...
SystemDashboardResponseMemory<PSCustomObject>
#>

function Initialize-GroAdminSystemDashboardResponseMemory {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: GrommunioAdmin => GroAdminSystemDashboardResponseMemory' | Write-Debug
...
Convert from JSON to SystemDashboardResponseMemory<PSCustomObject>
...
SystemDashboardResponseMemory<PSCustomObject>
#>
function ConvertFrom-GroAdminJsonToSystemDashboardResponseMemory {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: GrommunioAdmin => GroAdminSystemDashboardResponseMemory' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GroAdminSystemDashboardResponseMemory
