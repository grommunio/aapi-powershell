...
function Initialize-GroAdminSwap {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: GrommunioAdmin => GroAdminSwap' | Write-Debug
...
Convert from JSON to Swap<PSCustomObject>
...
Swap<PSCustomObject>
#>
function ConvertFrom-GroAdminJsonToSwap {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: GrommunioAdmin => GroAdminSwap' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GroAdminSwap
