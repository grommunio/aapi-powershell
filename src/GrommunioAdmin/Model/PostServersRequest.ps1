...
PostServersRequest<PSCustomObject>
#>

function Initialize-GroAdminPostServersRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: GrommunioAdmin => GroAdminPostServersRequest' | Write-Debug
...
Convert from JSON to PostServersRequest<PSCustomObject>
...
PostServersRequest<PSCustomObject>
#>
function ConvertFrom-GroAdminJsonToPostServersRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: GrommunioAdmin => GroAdminPostServersRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GroAdminPostServersRequest
